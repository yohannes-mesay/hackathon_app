...
function SavedServices() {
  ...
  return (
    <div className=" w-3/4 h-3/5 m-auto mt-0 pl-8">
      <div className=" mt-10 p-8 bg-slate-50 rounded-xl">
        <h1 className="relative -left-5 text-3xl font-semibold text-[color:var(--Green-text-color)] mb-4 relative left-0">
          Services
        </h1>
